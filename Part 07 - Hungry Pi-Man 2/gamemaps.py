...
real_folder = "/media/manuelpereira292/4716-5624/VS_Code/RB_PI4_Retro_Gaming/Part 07 - Hungry Pi-Man 2/"
moveimage = image.load(real_folder + 'images/pimanmovemap.png')
dotimage = image.load(real_folder + 'images/pimandotmap.png')
